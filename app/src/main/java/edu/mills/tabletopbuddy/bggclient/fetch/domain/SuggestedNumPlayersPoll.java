package edu.mills.tabletopbuddy.bggclient.fetch.domain;

import java.util.LinkedHashMap;
import java.util.Map;
import java.util.Map.Entry;

import edu.mills.tabletopbuddy.bggclient.fetch.domain.Poll.Result;
import edu.mills.tabletopbuddy.bggclient.fetch.domain.Poll.Results;
